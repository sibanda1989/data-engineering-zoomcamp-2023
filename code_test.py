#script I use to test code snippets before adoption in main scripts
import io
import os
import requests
import pandas as pd
...
BUCKET = os.environ.get("dtc_data_lake_local-bliss-375412", "dtc_data_lake_local-bliss-375412")
